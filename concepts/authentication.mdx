...
The following diagram illustrates the authentication flow within Pipevest.

<img height="200" src="/images/auth-flow.png" />
...
<Note>
  Granular scopes are yet to be implemented. All tokens are scoped have both
