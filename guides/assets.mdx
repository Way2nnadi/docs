...
<img height="100" src="/images/asset-account-portfolio.png" />
...
```bash
  curl --request GET \
    --url http://api.pipevest.com/v1/assets?customerId=123456\
...
```bash
  curl --request GET \
    --url http://api.pipevest.com/v1/assets?customerId=123456&accountId=123456\
    ...
```
...
```bash
  curl --request GET \
    --url http://api.pipevest.com/v1/assets?customerId=123456&portfolioId=123456\
    ...
```
...
```bash
  curl --request GET \
    --url http://api.pipevest.com/v1/assets/123456\
    ...
```
...
```bash
  curl --request POST \
    --url http://api.pipevest.com/v1/portfolio/assets\
    --header 'Authorization: Bearer 123456' \
