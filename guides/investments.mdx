...
```bash
  curl --request GET \
    --url http://api.pipevest.com/v1/investments\
...
```bash
  curl --request GET \
    --url http://api.pipevest.com/v1/investments/123456\
    ...
```
...
| `COMMODITY`            | No        | Allows trading of raw materials and basic resources (i.e. - Gold, Mining, Agricultral Products) |
