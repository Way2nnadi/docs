...
The client keys will be encrypted with the public key of the respective environment and sent over to your organization email on file.

<Note>
  Staging client keys will be encrypted using the staging public key, and the
  production client keys will be encrypted with the production public key
</Note>
